...
$sql = "UPDATE teachers SET name='$NAME', qualification = '$qualification', subject = '$subject' , location = '$location' , phone = '$phone' , email = '$email' ,email_verified_at = ' ', password ='$password' WHERE id='$ID'";
